...
extern directory_record_t *next_record(directory_record_t *ptr);
extern directory_record_t *find_record(const char *pattern, directory_record_t *begin, directory_record_t *end);
extern bool ident_cmp(const char *pattern, uint32_t ident_length, const char *ident);
extern void to_ident(char *pattern);
